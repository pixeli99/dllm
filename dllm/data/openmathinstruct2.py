...
def load_dataset_openmathinstruct2(
    ...
    elif train_limit is not None:  # test_limit is None
        n_test = max(100, int(total_rows * 0.01))
        n_train = min(int(train_limit), max(1, total_rows - n_test))
    else:  # test_limit is not None, train_limit is None
...
if __name__ == "__main__":
    # Quick smoke test: 20 train + 5 test.
